...
//    var maxWidth: CGFloat = 150
//    var cornerRadius: CGFloat = 15
//    var option = LegoThemes.allCases
//    @Binding var selection: String
//    // View Properies
//    @State private var showOption: Bool = false
//    // Environment scheme
...
//                HStack(spacing: 0) {
//                    Text(selection)
////                        .foregroundStyle(selection  ? .gray : .primary)
//                        .lineLimit(1)
//                    
//                    Spacer(minLength: 0)
//                    
...
//    func optionsView() -> some View {
//        VStack(spacing: 10) {
//            ForEach(option, id: \.id) { themeOpiton in
//                HStack(spacing: 0) {
//                    Text(themeOpiton.displayName)
//                        .tag(themeOpiton.rawValue)
//                        .lineLimit(1)
//                    
//                    Spacer(minLength: 0)
//                    
//                    Image(systemName: "checkmark")
//                        .font(.caption)
//                        .opacity(selection == themeOpiton.rawValue ? 1 : 0)
//                }
//                .foregroundStyle(selection == themeOpiton.rawValue ? Color.primary : Color.gray)
//                .animation(.none, value: selection)
//                .frame(height: 40)
//                .contentShape(.rect)
//                .onTapGesture {
//                    withAnimation(.snappy) {
//                        selection = themeOpiton.rawValue
//                        // Closing Drop Down view
//                        showOption = false
//                    }
//                }
